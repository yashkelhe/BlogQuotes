        ...
        <div className="flex justify-center w-full flex-col">
          ...
          <div className="w-[60%] m-auto">
            ...
            <button
              ...
              type="button"
              className={`text-white bg-gray-800 hover:bg-gray-900 font-medium rounded-lg text-sm px-5 py-3.5 me-2 my-4 w-full ${
            ...
            {type === "signin" ? (
              ...
              <button
                disabled={loading ? true : false}
                className={`text-white bg-blue-700 font-medium rounded-lg text-sm px-5 py-3.5 me-2 my-4 w-full  ${
                  loading ? "cursor-not-allowed" : ""
                }`}
                onClick={demoLogin}
              >
...
function LabelledInput({ label, type, placeholder, onChange }: valuesType) {
  return (
    <div>
      <label className="pt-4 block mb-1 font-medium text-gray-900">
        {label}
      </label>
      <input
        onChange={onChange}
