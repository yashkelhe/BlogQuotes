      ...
      <div className="flex justify-center w-full px-2">
        <div className="max-w-screen-xl w-full">
          <input
            ...
            type="text"
            className="bg-gray-100 outline-none text-gray-900 text-base rounded-lg block w-full p-3 pl-5 py-7 mt-5 mb-14"
            placeholder="Title"
            required
          />
          <button
            ...
            onClick={postBlog}
            type="submit"
            className={`mt-4 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg ${
